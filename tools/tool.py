...
def get_data_path(dataset='geant'):
    fea_path = ''
    if dataset == 'geant':
        fea_path = '/home/custdev/hm/PDFormerFlow-Prediction/dataset/geant_fea.npy'
    elif dataset == 'abilene':
        fea_path = '/home/custdev/hm/PDFormerFlow-Prediction/dataset/abilene_fea.npy'
    elif dataset == 'abilene05':
        fea_path = '/home/custdev/hm/PDFormerFlow-Prediction/dataset/abilene_fea_05.npy'
    elif dataset == 'nobel':
        fea_path = '/home/custdev/hm/PDFormerFlow-Prediction/dataset/nobel_germany.npy'
    elif dataset == 'germany':
        fea_path = '/home/custdev/hm/PDFormerFlow-Prediction/dataset/germany50.npy'
    return fea_path
...
def get_adj_matrix(dataset='abilene'):
    adj_path = ''
    if dataset == 'geant':
        adj_path = '/home/custdev/hm/PDFormerFlow-Prediction/dataset/geant_adj.npy'
    elif dataset == 'abilene':
        adj_path = '/home/custdev/hm/PDFormerFlow-Prediction/dataset/abilene_adj.npy'
    return adj_path
