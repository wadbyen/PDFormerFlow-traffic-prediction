...
parser.add_argument('--batch_size', '--bs', default=64*144, help='batch_size')
...
parser.add_argument('--sample_rate',default=0.5)
...
for r in range(rounds):
    ...
    # split dataset
    train_x, train_y, val_x, val_y, test_x, test_y, max_data,train_start,train_end = split_dataset_sample_time(data, train_rate=train_rate,val_rate=0.1,
                                                                                    seq_len=seq_len,
