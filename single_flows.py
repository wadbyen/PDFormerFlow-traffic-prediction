...
parser.add_argument('--dataset', default='geant', help='chose dataset', choices=['geant', 'abilene','nobel','germany'])
...
# parser.add_argument('--l2_loss', default=0, help='use l2 loscss')
